...
function ToAssignEmployees(){
    ...
    let assignemployees=(id)=>{
        ...
        //     if(assignedEmployees[i]==id){
        //         console.log(assignedEmployees[i])
        //         assignedEmployees.splice(1,1)
        ...
        // }
            ...
            // if (id in assignedEmployees[i]){
            //     assignedEmployees.pop(id)
            // }
            // else{
            //     setAssignedEmployees([...assignedEmployees,id])
            // }
    ...
    //     for(i=0;i<assignedEmployees.length;i++){
    //         console.log(i)
    //     }
    //     setAssignedEmployees([...assignedEmployees,assignedEmployees.remove(id)])
    // }
