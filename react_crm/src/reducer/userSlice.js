...
export const {setSuperAdminLogin,EmployeeRegisterDetails,setLoggedStatus,RegisterClient ,setClientLogin,updateUserLoginSuccess,setLoggedData,setEmpData} = userSlice.actions
